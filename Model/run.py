...
def main():
    ...
    input_data0 = xr.open_dataset('/data/EECS-Theory/Clim_risk_Lab_Zahir_Rendani/France-ALL/out/MF_JJA_Season.nc').isel(number=list(range(7)) + list(range(25, 33)),time=range(90))
    input_data1 = xr.open_dataset('/data/EECS-Theory/Clim_risk_Lab_Zahir_Rendani/France-ALL/Prcp/France_Prcp_JJA.nc').isel(number=range(7),time=range(90))
    ...
    target_data0 = xr.open_dataset('/data/EECS-Theory/Clim_risk_Lab_Zahir_Rendani/ERA5/temp/ERA_JJA_Season.nc')
